...
define( 'IG_UNIFORM_CAPTCHA_PUBLICKEY', '6LfdRNESAAAAAOOvsIa0AySHXcT7r6w7-QKJxIhz' );

define( 'IG_UNIFORM_CAPTCHA_PRIVATEKEY', '6LfdRNESAAAAADKbXLNxaZ8lvgwFosg__DOOy_DK' );

// Text domain for IG UniForm plugin
define( 'IG_UNIFORM_TEXTDOMAIN', 'ig-uniform' );

// Define product edition
define( 'IG_UNIFORM_EDITION', 'FREE' );

// Define product identified name
define( 'IG_UNIFORM_IDENTIFIED_NAME', 'ig_uniform' );

// Define product identified name
define( 'IG_UNIFORM_DEPENDENCY', '' );

// Define product identified name
define( 'IG_UNIFORM_ADDONS', 'ig_uniform_addons_profields' );
