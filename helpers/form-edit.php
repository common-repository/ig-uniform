						...
						<div class="form-captcha ui-state-default jsn-iconbar-trigger">
							<div class="recaptcha-content" style="text-align:  center;">
								...
								<div class="img-captcha">
									<span class="label label-important">Captcha is disabled</span><img src="<?php echo '' . get_site_url() . '/wp-content/plugins/ig-uniform/assets/images/recaptcha_pic.png';?>" data-recaptcha="<?php echo '' . get_site_url() . '/wp-content/plugins/ig-uniform/assets/images/recaptcha_pic.png';?>" data-securityimages="<?php echo '' . get_site_url() . '/wp-content/plugins/ig-uniform/assets/images/securitycaptcha_pic.png';?>" />
								</div>
								<input type="hidden" id="jform_form_captcha" name="ig_uniform[form_settings][form_captcha]" value="<?php echo '' . ( ! empty( $formSettings->form_captcha ) ? $formSettings->form_captcha : '' );?>">
							</div>
